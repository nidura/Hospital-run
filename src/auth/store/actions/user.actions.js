...
import { getUserData } from 'main/chatPanel/store/actions/user.actions';
import { getContacts } from 'main/chatPanel/store/actions/contacts.actions';
...
export const FETCH_USER_DATA = '[USER] FLETCHING DATA';
...
export function setUserData(user)
{
    return (dispatch) => {
        ...
        dispatch(getUserData(user.userId, user.data.displayName, user.data.photoURL));
        dispatch(getContacts(user.userId));
...
export function logoutUser()
{
    ...
    return (dispatch, getState) => {
        ...
        sessionStorage.removeItem('h2biz_18_userData');
        sessionStorage.removeItem('h2biz_18_navigationConfig');
