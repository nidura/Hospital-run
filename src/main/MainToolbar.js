                ...
                <div className="flex">
                    <FuseAnimate delay={300}>
                        <Button className="h-64" onClick={this.userMenuClick}>
                            {user.data.photoURL ?
                                (
                                    <Avatar className="" alt="user photo" src={window.imageUploadServer+"/"+user.data.photoURL}/>
                                )
                                :
                                (
                                    <Avatar className="">
                    ...
                    >
                        {user.role === 'guest' ? (
                            ...
                            <React.Fragment>
                                <MenuItem component={Link} to="/userManagement/userProfile" onClick={this.userMenuClose}>
                                    <ListItemIcon>
