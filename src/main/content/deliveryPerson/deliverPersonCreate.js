...
const DeliveryPersonForm = Form.create()(
      ...
      form.validateFields(async (err, values) => {
        if (err) {
          ...
          try {
            ...
            const result = await postApi(applicationAPI.saveDeliveryPerson, deliveryPerson);
            if (result.data.success) {
              message.success(result.data.message);
              this.props.form.resetFields();
              this.props.getDeliveryPersons();
