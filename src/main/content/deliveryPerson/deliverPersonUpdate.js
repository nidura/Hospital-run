...
const DeliveryPersonUpdateForm = Form.create()(
    class extends React.Component {
        ...
        render() {
            ...
            const initialVal = this.props.updatingDelPerson;
            console.log("vvvvvvvvvvv", initialVal)
                    ...
                    <Form onSubmit={this.handleSubmit} layout="vertical" className="customerForm">
                        ...
                        <Row gutter={24}>
                            <Col span={24}>
                                ...
                                >
                                    {getFieldDecorator("deliveryPersonName", {
                                        initialValue: "sdjhjhj",
                                        rules: [
                                            { required: true, message: "Delivery Person Required!" }
                                        ]
...
export default DeliveryPersonUpdateForm;
